      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="flex h-full w-60 max-w-full items-center px-4 py-2 xl:mr-12">
              <Link href="/" className="header-logo block h-full w-full">
                <Image
                  src="/images/logo/ar-logo.png"
                  alt="logo"
                  width={140}
                  height={30}
                  className="h-auto max-h-16 w-auto object-contain dark:hidden"
                />
                <Image
                  src="/images/logo/ar-logo.png"
                  alt="logo"
                  width={140}
                  height={30}
                  className="hidden h-auto max-h-16 w-auto object-contain dark:block"
                />
              </Link>
            </div>
